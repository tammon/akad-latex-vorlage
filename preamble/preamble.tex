...
\DeclareSectionCommand[
  ...
  afterskip=-0.5\parskip plus -1ex minus -.2ex, % counteract the paragraph skip to get very little vertical space between question and answer.     % chktex 1 commands cannot be terminated with curly braces in arguments
...
\newcommand{\faqitem}[2]{\question{#1}{\setlength{\leftskip}{4ex}#2\par}}
